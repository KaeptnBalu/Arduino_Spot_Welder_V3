These are the Gerber files for the Mosfet PCB V3.1. Please order it with 2oz copper layer at the pcb manufacturer because it needs to take a lot of current.
